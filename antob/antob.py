...
def create_project_file(dest):
    model = "text-davinci-002"
    prompt = "create a blazor webassembly .csproj file using net7 for <TargetFramework> and use version '7.0.0' for any packages starting with 'Microsoft.AspNetCore.Components'. Make sure the following packages are included 'Microsoft.AspNetCore.Components' and 'Microsoft.AspNetCore.Components.Web' and 'Microsoft.AspNetCore.Components.WebAssembly'. Do not include any xml statements or any project references. also format the result with appropriate line endings"
